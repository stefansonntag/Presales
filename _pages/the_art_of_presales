...
A good summary written by Stephen Street and James Belsey states;
...
In the Qlik world, any activities that happens prior to the software purchase and / or expansion of a deal involves;

+ Account planning meetings with Sales Reps
+ Demonstration of Qlik software
...
+ Seeing is Believing events (SiBs) – our version of a Proof of Concept
...
+ Helping Qlik staff to understand the capabilities of the products - this can include Sales and Marketing enablement
